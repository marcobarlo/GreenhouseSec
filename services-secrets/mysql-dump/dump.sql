...
GRANT SELECT, SHOW DATABASES, SHOW VIEW, INSERT, DELETE, UPDATE, EXECUTE, CREATE VIEW  ON *.* TO 'ServerGH'@'%' REQUIRE ISSUER '/C=IT/ST=Italia/L=Napoli/O=TrioDeDangers/OU=GH/CN=MariaDB admin' SUBJECT '/C=IT/ST=Italia/L=Napoli/O=TrioDeDangers/OU=GH/CN=MariaDB user';
FLUSH PRIVILEGES;
