...
public class Greenhouse1Application 
{
	...
	{	
		...
		if (okCxl == JOptionPane.OK_OPTION) 
		  password = new String(pf.getPassword());
	    	...
	    	System.exit(1);*/
		String password=System.getenv("XMLPASS");
		...
		password=System.getenv("KEYPASS");
		String passwordTrust = System.getenv("TRUSTPASS");
	/*	JPasswordField pf2 = new JPasswordField(24);
		...
		System.setProperty("javax.net.ssl.keyStore","/keystores/keystore"); 
	    System.setProperty("javax.net.ssl.keyStorePassword",password);
        System.setProperty("server.ssl.key-store-password", password);
	    ...
	    String encryptedMessage = System.getenv("KCSECRETENC");
	    System.setProperty("keycloak.credentials.secret", shsec.decrypt(encryptedMessage));
	    //System.setProperty("keycloak.credentials.secret", System.getenv("KEYCLOAKSECRET"));
	    System.setProperties(systemProps);
	    
	    //String mosquittopass = "Sidu1ENOEZv2ASbxXlWEYNmeh1tVpJEa";
	    String mosquittopass = doc.getElementsByTagName("password").item(0).getTextContent();
